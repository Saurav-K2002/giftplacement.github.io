...
const email_signature = '<br><br>With Regards.<br><br>Prof. Samir Kumar Panda<br>In-charge, Training & Placement<br>GIFT Bhubaneswar<br>+91-8292738623';
    ...
    switch (mailType) {
        ...
        case 'sendOTP':
            return {
                ...
                text: 'Hello '+ data.student_name + 'We have received a login request for your account.Please find the below OTP to proceed further With Regards, Prof. Samir Kumar Panda',
        ...
        case 'forgotPassword':
            return {
                ...
                text: 'Hello '+ data.student_name + 'You requested for the reset password.Please find the below link Reset password With Regards, Prof. Samir Kumar Panda',
        ...
        case 'passwordUpdated':
            return {
                ...
                text: 'Hello '+ data.student_name + 'Your password has been successfully updated.With Regards, Prof. Samir Kumar Panda',
        ...
        case 'approveInterviewExperience':
            return {
                from: from,
                to: data.author_id + '@gift.edu.in',
                subject: 'Yay! We have published your article ' + data.title,
                text: 'Hello '+ data.author_name + 'Thanks for sharing your interview process and thoughts with us With Regards, Prof. Samir Kumar Panda',
