    ...
    Company
        ...
        .then(async data => {
            ...
            for(let course in _b.eligibility){
                if(course == "UG"){
                    email.push(batch-4+"_ug_all@gift.edu.in");
                } else if(course == "MTech"){
                    email.push(batch-2+"_MTECH@gift.edu.in");
                } else if(course == "MPlan"){
                    email.push(batch-2+"_PAR@gift.edu.in");
                } else if(course == "MSc"){
                    email.push(batch-2+"_MSC@gift.edu.in");
                } else if(course == "MBA"){
                    email.push(batch-2+"_PBM@gift.edu.in");
                }
            }
